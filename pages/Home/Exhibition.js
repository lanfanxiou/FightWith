...
class Exhibition extends Component {
    ...
    _renderItemArticle=({item})=>{
        //alert((item.StartDate).substring(0,10));
        //alert(this.state.t2);
        return (
            ...
            <View>
                ...
                <View style={styles.cbeginsfa}>
                    <View style={styles.cbegins}>
                        ...
                        {this.state.t2 <((item.StartDate).substring(0,10)) ? <Text style={styles.cbeginstxt}>
                        ...
                        {this.state.t2 >((item.StartDate).substring(0,10))?<Text style={styles.cbeginstxt}>赛事结束</Text> :null}

                        {this.state.t2 ==((item.StartDate).substring(0,10))?<Text style={styles.cbeginstxt}>直播中</Text> :null}
